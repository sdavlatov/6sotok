...
export function ContactCard({ price, pricePerSotka, seller, slug }: ContactCardProps) {
        ...
        {cleanPhone ? (
          <>
            {isPhoneVisible ? (
              <a
                href={`tel:${cleanPhone}`}
                className="w-full rounded-2xl bg-primary py-4 font-extrabold text-white transition-all hover:bg-primary-light hover:-translate-y-0.5 active:scale-95 shadow-lg shadow-primary/20 flex items-center justify-center gap-2"
              >
